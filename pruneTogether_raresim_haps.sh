...
### use RAREsim to prune to pconf % all variants
...
python3 ${WD}/raresim/sim.py \
    ...
    -b ${WD}/mastersProject/Input/MAC_bin_estimates_${nsim}_${pop}_${pconf}.txt \
    ...
    -H ${WD}/mastersProject/20K_${pop}/pruneTogether/${int_prune}v${ext_prune}/chr19.block37.${pop}.sim${rep}.all.${pconf}.haps.gz
