...
unadj = data.frame(group = 'Unadjusted External Controls', value = counts_unadj$maf_case_unadj_cc)
adj = data.frame(group = 'Adjusted External Controls', value = counts_adj$maf_case_adj_cc)
...
p0
ggsave(file = paste0(dir_out, 'boxplot_rare_case_cc_maf_abs_diff_', Pop1, '_', Pop2, '_', scen, '_', folder, '_', int_prune, '_v_', ext_prune, '_maf', maf, '.jpg'), 
