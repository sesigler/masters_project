...
#gunzip ${WD}/Sim_100k/${pop1}/data/chr19.block37.${pop1}.sim${rep}.100000.controls.haps.gz
...
#gzip ${WD}/Sim_100k/${pop1}/data/chr19.block37.${pop1}.sim${rep}.100000.controls.haps

# gunzip the .controls.haps.gz file
#gunzip ${WD}/Sim_100k/${pop2}/data/chr19.block37.${pop2}.sim${rep}.100000.controls.haps.gz
...
#gzip the gunzipped hap file
#gzip ${WD}/Sim_100k/${pop2}/data/chr19.block37.${pop2}.sim${rep}.100000.controls.haps
