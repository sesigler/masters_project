...
python3 ${WD}/raresim/sim.py \
    ...
    -L ${WD}/mastersProject/20K_${pop}/${pruning}/${int_prune}v${ext_prune}/chr19.block37.${pop}.sim${rep}.${pcase}fun.${pexp}syn.legend \
    -H ${WD}/mastersProject/20K_${pop}/${pruning}/${int_prune}v${ext_prune}/chr19.block37.${pop}.sim${rep}.all.${pcase}fun.${pexp}syn.haps.gz

# Convert -H hap file to sm
python3 ${WD}/raresim/convert.py \
    -i ${WD}/mastersProject/20K_${pop}/${pruning}/${int_prune}v${ext_prune}/chr19.block37.${pop}.sim${rep}.all.${pcase}fun.${pexp}syn.haps.gz \
    -o ${WD}/mastersProject/20K_${pop}/${pruning}/${int_prune}v${ext_prune}/chr19.block37.${pop}.sim${rep}.all.${pcase}fun.${pexp}syn.haps.sm \

# Prune fun variants down to pexp %
python3 ${WD}/raresim/sim.py \
    -m ${WD}/mastersProject/20K_${pop}/${pruning}/${int_prune}v${ext_prune}/chr19.block37.${pop}.sim${rep}.all.${pcase}fun.${pexp}syn.haps.sm \
